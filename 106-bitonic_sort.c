 ...
 * through bitonic_compare, and merges the sorted results
 * @up: if true, sort in ascending order, false, descending
 ...
 * into a binary tree of subarrays, and then assigns sorting order.
 * @up: if true, sort in ascending order, false, descending
 * @x: subarray in previous frame of recursion
 * @size: length of elements in `x`
 * @orig_size: the number of elements in source array being sorted
 */
...
/**
 * bitonic_sort - this sorts array of integers in ascending order using
 * a bitonic sort alogrithm.
