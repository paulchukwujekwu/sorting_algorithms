 ...
 * ascending value
 * @array: array of values being sorted in place, from heap to ascending
 * @size: length of elements in array
...
/**
 * heap_sort - this sorts array of integers in ascending order using a
 * heap sort sift-down alogrithm
